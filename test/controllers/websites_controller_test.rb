...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference("Website.count") do
      post websites_url, params: { website: { restricted: @website.restricted, timeout: @website.timeout, url: @website.url } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { restricted: @website.restricted, timeout: @website.timeout, url: @website.url } }
